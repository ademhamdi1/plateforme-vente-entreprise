          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-gray-700 text-white font-semibold hover:bg-gray-800 active:scale-95 transition-all duration-200"
              >
                <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-success-500 text-white font-semibold hover:bg-success-600 active:scale-95 transition-all duration-200"
              >
                <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-warning-500 text-white font-semibold hover:bg-warning-600 active:scale-95 transition-all duration-200"
              >
                <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3H12M6 3.75h12a2.25 2.25 0 012.25 2.25v12A2.25 2.25 0 0118 20.25H6A2.25 2.25 0 013.75 18V6A2.25 2.25 0 016 3.75z" />
                </svg>
                Actualités
              </button>
            </div>
