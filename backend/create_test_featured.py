"""
Script pour mettre des entreprises en avant (featured) dans PostgreSQL
Usage: python manage.py shell < create_test_featured.py
"""
...
if not entreprises_publiees:
    ...
    print("💡 Exécutez d'abord: python manage.py shell < create_test_data.py")
else:
    count = 0
